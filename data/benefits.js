...
export default [
  {
    ...
    illustration: illustrations[0].active_recall,
  },
  {
    heading: "Practice spaced repetition",
    description:
      "Reinforce challenging concepts with a scientifically proven method for boosting memory retention.",
    illustration: illustrations[1].spaced_repitition,
  },
  {
    heading: "Focus on Core Vocabulary",
    description:
